package com.indi.yourgrame.ui.base.common
 ...
 * @since   2020-01-18
 */
class YourGrameUIContainer<T : ConstraintLayout>{
     ...
     */
    private object YourGrameUI {
        val INSTANCE = YourGrameUIContainer<ConstraintLayout>()
    }

    companion object {
        val instance by lazy { YourGrameUI.INSTANCE }
    }
}