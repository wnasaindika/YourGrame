...
class SearchListActivity : BaseActivity(), SearchListView,HasAndroidInjector{
    ...
    @Inject
    lateinit var listPresenter: ListPresenter<SearchListView,MeldCXViewModel>
    ...
    override fun addListSearchView(): View = getMeldCXUI().addListSearchView(this,list)
    override fun removeListSearchView()    = getMeldCXUI().removeListSearchView(list)
    //-- append  layouts ends
    /**
     * setting up recycler view
     */
    override fun setUpRecyclerView() : CaptureImageAdapter {
        val layerInit = getMeldCXUI().setUpRecyclerViewUtility(this)
